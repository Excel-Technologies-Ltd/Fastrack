...
export const PDF_POLICY: Record<string, PDFPolicy> = {
    ...
    [PDF_NAME_LIST.AIR_EXPORT_INVOICE_USD]: {
        name: PDF_NAME_LIST.AIR_EXPORT_INVOICE_USD,
        parentDoctype: DOCTYPE_LIST.EXPORT_AIR_HOUSE_BILL.NAME,
        isMasterBill: false,
        selectPDFNAME: true,
        selectDocName: true,
        selectCustomer: true,
        selectSupplier: false,
        selectChildDoctype: true,
        CHILD_DOCTYPE: DOCTYPE_LIST.EXPORT_AIR_HOUSE_BILL.CHILD_DOCTYPE.INVOICE_LIST.name,
        CUSTOMER_FIELDS: ["consignee", "notify_party", "customer"],
        DOWNLOAD_METHOD:
            "fastrack_erp.report_api.export_air_invoice_usd.download_export_air_invoice_usd_pdf",
        HAS_ARGUMENTS: true,
        ARGUMENTS: {
            invoice_ids: "selectedId",
            doc_name: "docName",
    ...
    [PDF_NAME_LIST.AIR_EXPORT_INVOICE_BDT]: {
        name: PDF_NAME_LIST.AIR_EXPORT_INVOICE_BDT,
        parentDoctype: DOCTYPE_LIST.EXPORT_AIR_HOUSE_BILL.NAME,
        isMasterBill: false,
        selectPDFNAME: true,
        selectDocName: true,
        ...
        CUSTOMER_FIELDS: ["consignee", "notify_party", "customer"],
        DOWNLOAD_METHOD:
            "fastrack_erp.report_api.export_air_invoice_bdt.download_export_air_invoice_bdt_pdf",
        HAS_ARGUMENTS: true,
        ARGUMENTS: {
            invoice_ids: "selectedId",
            doc_name: "docName",
